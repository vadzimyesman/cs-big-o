...
// 15) Here are two functions that you came up with to count how many of each letter is in a given string and return
...
// ANSWER:
//1st one will take more space unless the string passed contains all the letters from the alphabet, thet both fuctions will take equail space
...
//For the first one O(1)
//For the second one O(1)


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: 
//the first one will always store a variable called str and an object with 24 key-value pairs, the second one will
